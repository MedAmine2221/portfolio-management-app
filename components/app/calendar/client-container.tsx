    ...
    <>
      <div className="flex gap-4 justify-center flex-wrap mt-4">
        ...
        <div className="border-2 border-[#1a7ef0] rounded-xl shadow-lg bg-white p-6 flex flex-col items-center transition-transform hover:scale-105">
          <p className="text-gray-500 text-lg mb-1 font-bold">Number of customers :</p>
          <p className="text-2xl font-bold text-[#1a7ef0]">{clients.length > 0 ? clients.length : "pas des client" }</p>
        </div>

        {/* Card Projets */}
        <div className="border-2 border-[#1a7ef0] rounded-xl shadow-lg bg-white p-6 flex flex-col items-center transition-transform hover:scale-105">
          <p className="text-gray-500 text-lg mb-1 font-bold">Number of projects completed :</p>
