  ...
  return (
    <div className="w-full flex items-center justify-center p-4">
      <div className="flex flex-col justify-between items-center">
        <p className="text-5xl my-20 font-bold">Mohamed Amine's Portfolio Management</p>
        <div className="flex flex-row justify-center items-center">
          <div>
            <Image alt="amine" width={600} height={600} src= "/amine.png"  />
          </div>
          <div className="w-full max-w-md bg-white/10 backdrop-blur-sm shadow-2xl rounded-2xl p-8 flex flex-col gap-6">
            <h1 className="text-4xl text-black font-bold text-center">Welcome Back</h1>
            <AuthForm />
